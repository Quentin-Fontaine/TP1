...
//		// ----
		...
		model.arithm(rows[7][0], ">", rows[6][0]).post();
		model.arithm(rows[7][1], ">", rows[6][1]).post();
		model.arithm(rows[7][2], ">", rows[6][2]).post();
		...
		model.arithm(rows[7][3], ">", rows[6][3]).post();
		model.arithm(rows[7][4], "<", rows[6][4]).post();
		model.arithm(rows[7][5], ">", rows[6][5]).post();
		...
		model.arithm(rows[7][6], "<", rows[6][6]).post();
		model.arithm(rows[7][7], "<", rows[6][7]).post();
		model.arithm(rows[7][8], "<", rows[6][8]).post();
